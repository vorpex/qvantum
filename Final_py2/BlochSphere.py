...
def bloch_qubit(u, v, w):
    ...
    if isinstance(u, (int, long, float)) and isinstance(v, (int, long, float)) \
    and isinstance(w, (int, long, float)):
        ...
        logging.warning('Invalid input! Please use the following types: int, long or float for ' +\
        'u, v, w.')

def phase_test(c1, c2):
    ''' compute phase between two complex number '''

    if isinstance(c1, (int, long, float, complex)) and isinstance(c2, (int, long, float, complex)):
        ...
        logging.warning('Invalid input! Please use the following types: int, long, float or ' +\
        'complex for c1 and c2.')
